        ...
        child: Scaffold(
          appBar: AppBar(
            bottom: TabBar(
              tabs: [
                Tab(
                    child: Text('Classes', style: TextStyle(color: Colors.teal)),
                    icon: Icon(Icons.access_alarm, color: Colors.tealAccent)
                ),
                Tab(
                    child: Text('Raças', style: TextStyle(color: Colors.teal)),
                    icon: Icon(Icons.access_alarm, color: Colors.tealAccent)
                ),
                Tab(
                    child: Text('Magias', style: TextStyle(color: Colors.teal)),
                    icon: Icon(Icons.access_alarm, color: Colors.tealAccent)
                ),
              ],
            ),
